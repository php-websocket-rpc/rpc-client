...
| Class | Purpose |
|-------|---------|
| `PhpWebsocketRpc\RpcClient\Client\RpcClient` | Main client — connect, create proxies, close |
...
| `PhpWebsocketRpc\Rpc\Transport\FramedConnection` | Low-level framed WebSocket connection |
